...
#'  \item{IVHX}{IV drug use history (a \code{factor}):
#'   \describe{
#'    \item{1}{never}
#'    \item{2}{previous}
#'    \item{3}{current}}}
...
#'    \item{0}{short}
#'    \item{1}{long}}}
#'  \item{SITE}{Assignment treatment site (a \code{factor}):
#'   \describe{
#'    \item{0}{A}
#'    \item{1}{B}}}
...
#' \doi{10.1111/j.1360-0443.1997.tb02868.x}
#'
NULL
